...
(calc (parse '{with {x 4} {+ 3 4}}))
'if<
(calc (parse '{if< 12 4 100 0}))
(calc (parse '{if< 0 100 {with {x 3} {+ 2 x}} {with {x 6} {+ 2 x}}}))
(calc (parse '{if< 110 100 {with {x 3} {+ 2 x}} {with {x 6} {+ 2 x}}}))
(calc (parse '{if< 100 100 {with {x 3} {+ 2 x}} {with {x 6} {+ 2 x}}}))
(calc (parse '{with {x 9} {if< x 100 {with {y 3} {+ 2 y}} {with {y 6} {+ x y}}}}))
(calc (parse '{with {x 9} {if< 100 x {with {y 3} {+ 2 y}} {with {y 6} {+ x y}}}}))
(calc (parse '{with {x 9} {with {z 12} {if< x z {* 7 7} {with {y 6} {/ x y}}}}}))
(calc (parse '{with {x 9} {with {z 12} {if< z x {* 7 7} {with {y 6} {/ x y}}}}}))
